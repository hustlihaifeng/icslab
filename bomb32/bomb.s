...
08048b20 <phase_1>:
 ...
 8048b2c:	68 c0 97 04 08       	push   $0x80497c0                       //字符串地址
 8048b31:	50                   	push   %eax
...
08048b48 <phase_2>:
 ...
 8048b4b:	83 ec 20             	sub    $0x20,%esp                           //32字节的栈帧
 8048b4e:	56                   	push   %esi
 8048b4f:	53                   	push   %ebx
 8048b50:	8b 55 08             	mov    0x8(%ebp),%edx                       //edx里面存了入口参数
 8048b53:	83 c4 f8             	add    $0xfffffff8,%esp
 8048b56:	8d 45 e8             	lea    -0x18(%ebp),%eax                     //eax里面是ebp下第六个四字节处
 8048b59:	50                   	push   %eax
 8048b5a:	52                   	push   %edx
 8048b5b:	e8 78 04 00 00       	call   8048fd8 <read_six_numbers>           //很有可能将6个入口参数存到ebp下6个四字节处
 8048b60:	83 c4 10             	add    $0x10,%esp
 8048b63:	83 7d e8 01          	cmpl   $0x1,-0x18(%ebp)                     //第一个入口参数为1
 8048b67:	74 05                	je     8048b6e <phase_2+0x26>
 8048b69:	e8 8e 09 00 00       	call   80494fc <explode_bomb>
 8048b6e:	bb 01 00 00 00       	mov    $0x1,%ebx                            //i=1 ebx
 8048b73:	8d 75 e8             	lea    -0x18(%ebp),%esi                     //esi=a 
 8048b76:	8d 43 01             	lea    0x1(%ebx),%eax                       //b=i+1,for开始
 8048b79:	0f af 44 9e fc       	imul   -0x4(%esi,%ebx,4),%eax               //s=b*a[i-1]
 8048b7e:	39 04 9e             	cmp    %eax,(%esi,%ebx,4)                   //a[i]==s则继续
 8048b81:	74 05                	je     8048b88 <phase_2+0x40>               //ebp下20字节处为2
 8048b83:	e8 74 09 00 00       	call   80494fc <explode_bomb>
 8048b88:	43                   	inc    %ebx                                 //i++;
 8048b89:	83 fb 05             	cmp    $0x5,%ebx                            //
 8048b8c:	7e e8                	jle    8048b76 <phase_2+0x2e>               //i<=5继续
...
08048b98 <phase_3>:
 ...
 8048b9b:	83 ec 14             	sub    $0x14,%esp                       //20B stack ebp[20]
 8048b9e:	53                   	push   %ebx                             
 8048b9f:	8b 55 08             	mov    0x8(%ebp),%edx                   //argument is in edx
 8048ba2:	83 c4 f4             	add    $0xfffffff4,%esp                 // 
 8048ba5:	8d 45 fc             	lea    -0x4(%ebp),%eax                  
 8048ba8:	50                   	push   %eax                             //second %d, the last argument is topest, first push 
 8048ba9:	8d 45 fb             	lea    -0x5(%ebp),%eax                  
 8048bac:	50                   	push   %eax                             //%c
 8048bad:	8d 45 f4             	lea    -0xc(%ebp),%eax                  
 8048bb0:	50                   	push   %eax                             //%d and pay attention to the aligh
 8048bb1:	68 de 97 04 08       	push   $0x80497de                       //format
 8048bb6:	52                   	push   %edx                             //source string
 8048bb7:	e8 a4 fc ff ff       	call   8048860 <sscanf@plt>             //input
 8048bbc:	83 c4 20             	add    $0x20,%esp                       //esp=20
 8048bbf:	83 f8 02             	cmp    $0x2,%eax                        
 8048bc2:	7f 05                	jg     8048bc9 <phase_3+0x31>           // if (!(infile = fopen(argv[1], "r"))) {
 8048bc4:	e8 33 09 00 00       	call   80494fc <explode_bomb>           // must input more than 2 item
 8048bc9:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)                  
 8048bcd:	0f 87 b5 00 00 00    	ja     8048c88 <phase_3+0xf0>           // first %d must <= 7
 8048bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax                  // i=ebp[9-12]
 8048bd6:	ff 24 85 e8 97 04 08 	jmp    *0x80497e8(,%eax,4)              // a=0x80497e8, goto a[i]
 8048bdd:	8d 76 00             	lea    0x0(%esi),%esi                   //
 8048be0:	b3 71                	mov    $0x71,%bl                        //%c
 8048be2:	81 7d fc 09 03 00 00 	cmpl   $0x309,-0x4(%ebp)                
 8048be9:	0f 84 a0 00 00 00    	je     8048c8f <phase_3+0xf7>           //second %d
 ...
 8048c88:	b3 78                	mov    $0x78,%bl                            // if ebp[9-12]>7, come here ,bomb          
 8048c8a:	e8 6d 08 00 00       	call   80494fc <explode_bomb>
 8048c8f:	3a 5d fb             	cmp    -0x5(%ebp),%bl                       //
 8048c92:	74 05                	je     8048c99 <phase_3+0x101>              //now bl must be ebp[5], now can win!
...
08048ca0 <func4>:
 ...
 8048ca3:	83 ec 10             	sub    $0x10,%esp           //16B stack
 8048ca6:	56                   	push   %esi
 8048ca7:	53                   	push   %ebx
 8048ca8:	8b 5d 08             	mov    0x8(%ebp),%ebx       //a is in ebx
 8048cab:	83 fb 01             	cmp    $0x1,%ebx            //a should more than 0x1
 8048cae:	7e 20                	jle    8048cd0 <func4+0x30>
 8048cb0:	83 c4 f4             	add    $0xfffffff4,%esp     
 8048cb3:	8d 43 ff             	lea    -0x1(%ebx),%eax      //a--, if a<=1, return 0x1, func4(a-1)
 8048cb6:	50                   	push   %eax
 8048cb7:	e8 e4 ff ff ff       	call   8048ca0 <func4>
 8048cbc:	89 c6                	mov    %eax,%esi            //return value of func4 to esi,first 0x1
 8048cbe:	83 c4 f4             	add    $0xfffffff4,%esp
 8048cc1:	8d 43 fe             	lea    -0x2(%ebx),%eax      //func4(a-2)
 8048cc4:	50                   	push   %eax
 8048cc5:	e8 d6 ff ff ff       	call   8048ca0 <func4>
 8048cca:	01 f0                	add    %esi,%eax            //func4(a)=func4(a-1)+func4(a-2) if a<=1 func4 is 1
...
08048ce0 <phase_4>:
 ...
 8048ce3:	83 ec 18             	sub    $0x18,%esp               //24B stack
 8048ce6:	8b 55 08             	mov    0x8(%ebp),%edx           //input is in edx, let it be "a".("9")
 8048ce9:	83 c4 fc             	add    $0xfffffffc,%esp
 8048cec:	8d 45 fc             	lea    -0x4(%ebp),%eax
 8048cef:	50                   	push   %eax                     //last argu, a is in ebp[1-4]
 8048cf0:	68 08 98 04 08       	push   $0x8049808               //secont argu "%d"
 8048cf5:	52                   	push   %edx                     //first argu
 8048cf6:	e8 65 fb ff ff       	call   8048860 <sscanf@plt>
 8048cfb:	83 c4 10             	add    $0x10,%esp
 8048cfe:	83 f8 01             	cmp    $0x1,%eax                //input one item
 8048d01:	75 06                	jne    8048d09 <phase_4+0x29>
 8048d03:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)          
 8048d07:	7f 05                	jg     8048d0e <phase_4+0x2e>   //a should be greater than 0
 8048d09:	e8 ee 07 00 00       	call   80494fc <explode_bomb>
 8048d0e:	83 c4 f4             	add    $0xfffffff4,%esp
 8048d11:	8b 45 fc             	mov    -0x4(%ebp),%eax
 8048d14:	50                   	push   %eax                     //a int
 8048d15:	e8 86 ff ff ff       	call   8048ca0 <func4>
 8048d1a:	83 c4 10             	add    $0x10,%esp
 8048d1d:	83 f8 37             	cmp    $0x37,%eax 
 8048d20:	74 05                	je     8048d27 <phase_4+0x47>   //func4(a)'s return value should be 0x37
...
08048d2c <phase_5>:
 ...
 8048d2f:	83 ec 10             	sub    $0x10,%esp               //16B stack
 8048d32:	56                   	push   %esi
 8048d33:	53                   	push   %ebx
 8048d34:	8b 5d 08             	mov    0x8(%ebp),%ebx           //argument is in ebx (opu/ekmq/a)
 8048d37:	83 c4 f4             	add    $0xfffffff4,%esp
 8048d3a:	53                   	push   %ebx                     //ebx
 8048d3b:	e8 d8 02 00 00       	call   8049018 <string_length>
 8048d40:	83 c4 10             	add    $0x10,%esp
 8048d43:	83 f8 06             	cmp    $0x6,%eax                //string_length should be 6
 8048d46:	74 05                	je     8048d4d <phase_5+0x21>mZ
 8048d48:	e8 af 07 00 00       	call   80494fc <explode_bomb>
 8048d4d:	31 d2                	xor    %edx,%edx                //edx is 0x0, i
 8048d4f:	8d 4d f8             	lea    -0x8(%ebp),%ecx          //ecx=ebp-8
 8048d52:	be 20 b2 04 08       	mov    $0x804b220,%esi          //esi=0x804b220
 8048d57:	8a 04 1a             	mov    (%edx,%ebx,1),%al        //for(i=0;i<=5;i++){al=str[i];al=al&0xf;ecx[i]=0x20+al;}
 8048d5a:	24 0f                	and    $0xf,%al                 //al=00001111&al
 8048d5c:	0f be c0             	movsbl %al,%eax                 //0x0000000al
 8048d5f:	8a 04 30             	mov    (%eax,%esi,1),%al        //al=al+0x804b220;
 8048d62:	88 04 0a             	mov    %al,(%edx,%ecx,1)        //ecx[i]=al;
 8048d65:	42                   	inc    %edx                     //edx++
 8048d66:	83 fa 05             	cmp    $0x5,%edx
 8048d69:	7e ec                	jle    8048d57 <phase_5+0x2b>   //here is a loop
 8048d6b:	c6 45 fe 00          	movb   $0x0,-0x2(%ebp)          //ebp[2]=0
 8048d6f:	83 c4 f8             	add    $0xfffffff8,%esp
 8048d72:	68 0b 98 04 08       	push   $0x804980b               //giants
 8048d77:	8d 45 f8             	lea    -0x8(%ebp),%eax          //must be giants
 8048d7a:	50                   	push   %eax
 8048d7b:	e8 b0 02 00 00       	call   8049030 <strings_not_equal> 
 8048d80:	83 c4 10             	add    $0x10,%esp
 8048d83:	85 c0                	test   %eax,%eax                //ZF=1 iff eax=0
 8048d85:	74 05                	je     8048d8c <phase_5+0x60>   //jump is ZF=1
 8048d87:	e8 70 07 00 00       	call   80494fc <explode_bomb>
 8048d8c:	8d 65 e8             	lea    -0x18(%ebp),%esp         //here is right
 8048d8f:	5b                   	pop    %ebx
 8048d90:	5e                   	pop    %esi
...
08048d98 <phase_6>:
 ...
 8048d9b:	83 ec 4c             	sub    $0x4c,%esp               //76B stack
 8048d9e:	57                   	push   %edi
 8048d9f:	56                   	push   %esi
 8048da0:	53                   	push   %ebx
 8048da1:	8b 55 08             	mov    0x8(%ebp),%edx           //argument is in edx
 8048da4:	c7 45 cc 6c b2 04 08 	movl   $0x804b26c,-0x34(%ebp)   //ebp[31-34]=0x804b26c
 8048dab:	83 c4 f8             	add    $0xfffffff8,%esp
 8048dae:	8d 45 e8             	lea    -0x18(%ebp),%eax         //ebp[1-24] store 6 number
 8048db1:	50                   	push   %eax
 8048db2:	52                   	push   %edx
 8048db3:	e8 20 02 00 00       	call   8048fd8 <read_six_numbers>
                                                                    //{                            
 8048db8:	31 ff                	xor    %edi,%edi                //i=edi=0;
 8048dba:	83 c4 10             	add    $0x10,%esp
 8048dbd:	8d 76 00             	lea    0x0(%esi),%esi

 8048dc0:	8d 45 e8             	lea    -0x18(%ebp),%eax         ////eax=array loop begin
 8048dc3:	8b 04 b8             	mov    (%eax,%edi,4),%eax       //for(i=0;i<=5;i++){a=array[i];
 8048dc6:	48                   	dec    %eax                     //a--;
 8048dc7:	83 f8 05             	cmp    $0x5,%eax                //if(a>5){bomb();}
 8048dca:	76 05                	jbe    8048dd1 <phase_6+0x39>
 8048dcc:	e8 2b 07 00 00       	call   80494fc <explode_bomb>
                                                                    //{
 8048dd1:	8d 5f 01             	lea    0x1(%edi),%ebx           //j=ebx=i+1;
 8048dd4:	83 fb 05             	cmp    $0x5,%ebx                //while(j<=5){if(array[j]==array[i]){bomb();}j++;}
 8048dd7:	7f 23                	jg     8048dfc <phase_6+0x64>   ////if(j greater than 5){ goto i++; }
 8048dd9:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax        
 8048de0:	89 45 c8             	mov    %eax,-0x38(%ebp)         
 8048de3:	8d 75 e8             	lea    -0x18(%ebp),%esi         ////esi=array;
 8048de6:	8b 55 c8             	mov    -0x38(%ebp),%edx         ////edx=4*i; inner loop 
 8048de9:	8b 04 32             	mov    (%edx,%esi,1),%eax       ////eax=&array[i];
 8048dec:	3b 04 9e             	cmp    (%esi,%ebx,4),%eax       
 8048def:	75 05                	jne    8048df6 <phase_6+0x5e>
 8048df1:	e8 06 07 00 00       	call   80494fc <explode_bomb>   ////if(array[i+1]==array[i]){bomb();}
 8048df6:	43                   	inc    %ebx                     ////j++;
 8048df7:	83 fb 05             	cmp    $0x5,%ebx
 8048dfa:	7e ea                	jle    8048de6 <phase_6+0x4e>   ////inner loop end
                                                                    //}
 8048dfc:	47                   	inc    %edi                     //i++;
 8048dfd:	83 ff 05             	cmp    $0x5,%edi
 8048e00:	7e be                	jle    8048dc0 <phase_6+0x28>   //loop end} //this above code enseure that array[j]!=array[i]
                                                                    //}
                                                                    ...
                                                                    //}while(i<5);
                                                                    //{
8048e02:	31 ff                	xor    %edi,%edi                //i==edi=0; //loop begin
 8048e04:	8d 4d e8             	lea    -0x18(%ebp),%ecx         //ecx=array;
 8048e07:	8d 45 d0             	lea    -0x30(%ebp),%eax         //
 8048e0a:	89 45 c4             	mov    %eax,-0x3c(%ebp)         //ebp[57-60]=&ebp[48]
 8048e0d:	8d 76 00             	lea    0x0(%esi),%esi
                                                                    //{
 8048e10:	8b 75 cc             	mov    -0x34(%ebp),%esi         //esi=ebp[49-52]
 8048e13:	bb 01 00 00 00       	mov    $0x1,%ebx                //j=ebx=1
 8048e18:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax
 8048e1f:	89 c2                	mov    %eax,%edx                //edx=eax=4*i
 8048e21:	3b 1c 08             	cmp    (%eax,%ecx,1),%ebx       //if(array[i]>j){goto e38}
 8048e24:	7d 12                	jge    8048e38 <phase_6+0xa0>
 8048e26:	8b 04 0a             	mov    (%edx,%ecx,1),%eax       //eax=array[i];
 8048e29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi    //eiz is 0,usually this line if for align
                                                                    //{
 8048e30:	8b 76 08             	mov    0x8(%esi),%esi           //
 8048e33:	43                   	inc    %ebx                     //
 8048e34:	39 c3                	cmp    %eax,%ebx                //do{esi=*(esi+8);j++;}while(array[i]<j)
 8048e36:	7c f8                	jl     8048e30 <phase_6+0x98>
                                                                    //}
 8048e38:	8b 55 c4             	mov    -0x3c(%ebp),%edx         //B=edx=&ebp[48];
 8048e3b:	89 34 ba             	mov    %esi,(%edx,%edi,4)       //B[i]=esi;
 8048e3e:	47                   	inc    %edi                     //i++
 8048e3f:	83 ff 05             	cmp    $0x5,%edi                //while(i<5)
 8048e42:	7e cc                	jle    8048e10 <phase_6+0x78>
                                                                    //}}
 8048e44:	8b 75 d0             	mov    -0x30(%ebp),%esi         //esi=B[0];
 8048e47:	89 75 cc             	mov    %esi,-0x34(%ebp)         //tmp=B[0]
 8048e4a:	bf 01 00 00 00       	mov    $0x1,%edi                //i=edi=1
 8048e4f:	8d 55 d0             	lea    -0x30(%ebp),%edx         //edx=B
 8048e52:	8b 04 ba             	mov    (%edx,%edi,4),%eax       //do{*(esi+8)=B[i];esi=B[i];i++}while(i<=5);
 ...
 8048e60:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)           //*(esi+8)=0
 8048e67:	8b 75 cc             	mov    -0x34(%ebp),%esi         //esi=tmp;
 8048e6a:	31 ff                	xor    %edi,%edi                //i=0;
 8048e6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 8048e70:	8b 56 08             	mov    0x8(%esi),%edx           //do{if(*esi<**(esi+8)){bomb();}esi=*(esi+8);i++}while(i<=4);
...
08049030 <strings_not_equal>:
 ...
 8049037:	56                   	push   %esi
 8049038:	53                   	push   %ebx
 8049039:	8b 75 08             	mov    0x8(%ebp),%esi               //esi
 804903c:	8b 7d 0c             	mov    0xc(%ebp),%edi               //edi
